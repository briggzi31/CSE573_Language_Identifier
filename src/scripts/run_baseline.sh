...
./src/scripts/classify_languages.sh 3 3 3 0 True accuracy/baseline/acc_3_3_3
...
./src/scripts/classify_languages.sh 9 3 3 0 True accuracy/baseline/acc_9_3_3
echo "finished 9 3 3 (5/8)"

./src/scripts/classify_languages.sh 9 3 9 0 True accuracy/baseline/acc_9_3_9
echo "finished 9 3 9 (6/8)"

./src/scripts/classify_languages.sh 9 9 3 0 True accuracy/baseline/acc_9_9_3
echo "finished 9 9 3 (7/8)"

./src/scripts/classify_languages.sh 9 9 9 0 True accuracy/baseline/acc_9_9_9
